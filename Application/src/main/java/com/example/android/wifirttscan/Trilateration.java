...
//    private double[] ap3 = new double[]{4,3};
    ...
    public double[] getPosition(){
        ...
        double C = Math.pow(r1,2)-Math.pow(r2,2)-Math.pow(ap1[0],2)+Math.pow(ap2[0],2)-Math.pow(ap1[1],2)+Math.pow(ap2[1],2);
        double D = -2*ap2[0]+2*ap3[0];
        double E = -2*ap2[1]+2*ap3[1];
        double F = Math.pow(r2,2)-Math.pow(r3,2)-Math.pow(ap2[0],2)+Math.pow(ap3[0],2)-Math.pow(ap2[1],2)+Math.pow(ap3[1],2);
